...
public class TelaPrincipal extends JFrame {
    ...
    public void animarDespacho(Ambulancia amb, java.util.List<Vertice> rotaCompleta, Runnable aoTerminar, Vertice localPaciente) {
        animarDespacho(amb, rotaCompleta, true, aoTerminar, localPaciente);
    }

    public void animarDespacho(Ambulancia amb, java.util.List<Vertice> rotaCompleta, boolean destacarRota, Runnable aoTerminar) {
        animarDespacho(amb, rotaCompleta, destacarRota, aoTerminar, null);
    }

    public void animarDespacho(Ambulancia amb, java.util.List<Vertice> rotaCompleta, boolean destacarRota, Runnable aoTerminar, Vertice localPaciente) {
